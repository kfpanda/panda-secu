...
public class SysSessionSql {
	...
	public static final String FIELDS = "`id`,`createtime`,`sessionid`,`session`";
	public static final String SAVE_FIELD = "`createtime`,`sessionid`,`session`";
	public static final String BEAN_FIELD_NAME = "#{createTime},#{sessionId},#{session}";
