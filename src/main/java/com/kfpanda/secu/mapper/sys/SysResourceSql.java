...
public class SysResourceSql {
	...
	public static final String FIELDS = "`id`,`pid`,`name`,`code`,`type`,`url`,`status`,`order`,`remark`,`createtime`";
	public static final String SAVE_FIELD = "`pid`,`name`,`code`,`type`,`url`,`status`,`order`,`remark`,`createtime`";
	public static final String BEAN_FIELD_NAME = "#{pid},#{name},#{code},#{type},#{url},#{status},#{order},#{remark},#{createtime}";
