...
import com.kfpanda.secu.service.sys.SysRoleResourceService;
...
public class SysRoleResourceAction extends BaseAction{
	/** 日志 **/
	private Logger logger = LoggerFactory.getLogger(SysRoleResourceAction.class);
	/** 权限service **/
	@Autowired
