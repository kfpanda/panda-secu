...
$("#addazl").click(function(){
	if($("#zlinputs .row1_box_half").length > 9){
		...
		$(this).parent().prev().append("<div class='row1_box_half'><div class='suggestionsBox suggestions' style='display:none;'><ul class='suggestionList autoSuggestionsList' ></ul></div><div class='input_text_item1'><input class='inputtext_scname' value='' type='text' placeholder='点击这里输入工具原料' name='q' defaultval='点击这里输入工具原料' autocomplete='off' href='/ajax/shicai_rel.php'></div><span class='delsc'></span></div> ");
...
$("#addafl").click(function(){
	if($("#flinputs .row1_box_half").length > 29){
		...
		$(this).parent().prev().append("<div class='row1_box_half'><div class='suggestionsBox suggestions' style='display:none;'><ul class='suggestionList autoSuggestionsList' ></ul></div><div class='input_text_item1'><input class='inputtext_scname' value='' type='text' placeholder='点击这里输入注意事项' name='q' defaultval='点击这里输入工具原料' autocomplete='off' href='/ajax/shicai_rel.php'></div><span class='delsc'></span></div> ");
	}
...
function add_step() {
	...
	if($("#steps .stepitem").length > 99){
		...
		$("#addstep_btn").parent().prev().append("<div class='stepitem'><div class='stepnum'></div><div class='stepright'><div class='stepst_w'><div class='stepst_tips'>更多步骤细节（选填） ></div><div class='stepst'><div class='step_scselect'><div class='step_scselect_item'><span class='t'>此步骤所用食材：</span><input type='hidden' value='' class='step_sc_input' name='step_sc_input[]'><div class='c'><dl class='zl clearfix'><dt class='zl'><span class='s1'>主料</span><span class='s2'>步骤用量（可修改）</span></dt></dl><dl class='fl clearfix'><dt class='fl'><span class='s1'>辅料</span><span class='s2'>步骤用量（可修改）</span></dt></dl></div></div><p>此步骤所用食材：</p><div class='selectitem_l'><p>请选择食材</p></div></div><div class='step_timeselect'><p>此步骤所用时间：</p><div class='timeinput'><input type='text' name='step_time[]'></div><span class='timedw_select'>分钟</span></div></div></div>" +
				"<textarea placeholder='请填写步骤描述' name='step_text"+jybz+"'></textarea>" +
				"<ul class='uppiclist add_"+jybz+"'>" +				  
				"<li>" +
				"<input type='hidden' name='bztps_img0'>" +
				"<a class='stepupload' href='javascript:addbzjyimg("+jybz+")'></a>" +
				"</li>" +				
				"</ul></div><div class='step_rightbtns'><a href='####' class='moveUp'></a><a href='####' class='moveDown'></a><a href='####' class='addStep'></a><a href='####' class='delStep'></a></div></div>");
	}
...
function addbzjyimg(aa){	
	if($(".add_"+aa).find("li").length==8){
		alert("抱歉，最多只允许上传7张步骤图");
		return ;
	}
	$('input[name="fileImg"]').attr("class",aa);
	$('input[name="fileImg"]').click();
}
...
function relist_zl(){
	...
	var i = 1;
	for(var i = 0;i<len;i++){
		$(list[i]).attr("name","zlsc"+String(i+1));
		/*if(i%2 == 0){
...
function relist_fl(){
	...
	var len = list.length;
	for(var i = 0;i<len;i++){
		$(list[i]).attr("name","flsc"+String(i));
		/*if(i%2 == 0){
